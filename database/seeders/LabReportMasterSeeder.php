    ...
    private function getHematologyTests(): array
    {
        return [
            ...
            [
                ...
                'parameters' => [
                    // White Blood Cells - BHA 3000 Style
                    'wbc' => ['name' => 'Total Leukocyte Count (TLC/WBC)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'lymphocytes_absolute' => ['name' => 'LYM #', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'mid_absolute' => ['name' => 'MID #', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'gran_absolute' => ['name' => 'GRAN #', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'lymphocytes_percent' => ['name' => 'LYM %', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'mid_percent' => ['name' => 'MID %', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'gran_percent' => ['name' => 'GRAN %', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    // Red Blood Cells
                    'hemoglobin' => ['name' => 'HGB/HEMOGLOBIN', 'unit' => 'g/dL', 'type' => 'numeric', 'required' => true],
                    'rbc' => ['name' => 'RBC', 'unit' => 'x10⁶/μL', 'type' => 'numeric', 'required' => true],
                    ...
                    'mchc' => ['name' => 'MCHC', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'rdw_cv' => ['name' => 'RDW', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    // Platelets
                    'platelets' => ['name' => 'PLATELETS COUNT', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'mpv' => ['name' => 'MPV', 'unit' => 'fL', 'type' => 'numeric', 'required' => false],
                    'pdw' => ['name' => 'PDW', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'pct' => ['name' => 'PCT', 'unit' => '%', 'type' => 'numeric', 'required' => false],
