    ...
    private function getHematologyTests(): array
    {
        return [
            [
                ...
                'reference_ranges' => [
                    // White Blood Cells
                    'wbc' => ['min' => 4.5, 'max' => 11.0, 'unit' => 'x10³/μL', 'default' => null],
                    'neutrophils_percent' => ['min' => 40, 'max' => 70, 'unit' => '%', 'default' => null],
                    'lymphocytes_percent' => ['min' => 20, 'max' => 40, 'unit' => '%', 'default' => null],
                    'monocytes_percent' => ['min' => 2, 'max' => 10, 'unit' => '%', 'default' => null],
                    'eosinophils_percent' => ['min' => 1, 'max' => 6, 'unit' => '%', 'default' => null],
                    'basophils_percent' => ['min' => 0, 'max' => 1, 'unit' => '%', 'default' => null],
                    'neutrophils_absolute' => ['min' => 2.0, 'max' => 7.5, 'unit' => 'x10³/μL', 'default' => null],
                    'lymphocytes_absolute' => ['min' => 1.0, 'max' => 4.5, 'unit' => 'x10³/μL', 'default' => null],
                    'monocytes_absolute' => ['min' => 0.1, 'max' => 1.5, 'unit' => 'x10³/μL', 'default' => null],
                    'eosinophils_absolute' => ['min' => 0.0, 'max' => 0.9, 'unit' => 'x10³/μL', 'default' => null],
                    'basophils_absolute' => ['min' => 0.0, 'max' => 0.15, 'unit' => 'x10³/μL', 'default' => null],
                    // WBC Differential Groups (BHA 3000 style)
                    'mid_percent' => ['min' => 2.0, 'max' => 10.0, 'unit' => '%', 'default' => null],
                    'mid_absolute' => ['min' => 0.1, 'max' => 1.5, 'unit' => 'x10³/μL', 'default' => null],
                    'gran_percent' => ['min' => 54, 'max' => 62, 'unit' => '%', 'default' => null],
                    'gran_absolute' => ['min' => 2.0, 'max' => 6.0, 'unit' => 'x10³/μL', 'default' => null],
                    // Red Blood Cells
                    'rbc' => ['min' => 4.5, 'max' => 5.5, 'unit' => 'x10⁶/μL', 'default' => null],
                    'hemoglobin' => ['min' => 13.5, 'max' => 17.5, 'unit' => 'g/dL', 'default' => null],
                    'hematocrit' => ['min' => 38, 'max' => 50, 'unit' => '%', 'default' => null],
                    'mcv' => ['min' => 80, 'max' => 100, 'unit' => 'fL', 'default' => null],
                    'mch' => ['min' => 27, 'max' => 33, 'unit' => 'pg', 'default' => null],
                    'mchc' => ['min' => 32, 'max' => 36, 'unit' => 'g/dL', 'default' => null],
                    'rdw_cv' => ['min' => 11.5, 'max' => 14.5, 'unit' => '%', 'default' => null],
                    // Platelets
                    'platelets' => ['min' => 150, 'max' => 450, 'unit' => 'x10³/μL', 'default' => null],
                    'mpv' => ['min' => 7.5, 'max' => 11.5, 'unit' => 'fL', 'default' => null],
                    'pdw' => ['min' => 10, 'max' => 18, 'unit' => '%', 'default' => null],
                    'pct' => ['min' => 0.12, 'max' => 0.24, 'unit' => '%', 'default' => null],
                    'p_lcr' => ['min' => 13, 'max' => 43, 'unit' => '%', 'default' => null],
                ],
                'parameters' => [
                    // White Blood Cells
                    'wbc' => ['name' => 'White Blood Cells (WBC)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'neutrophils_percent' => ['name' => 'Neutrophils %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'lymphocytes_percent' => ['name' => 'Lymphocytes %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'monocytes_percent' => ['name' => 'Monocytes %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'eosinophils_percent' => ['name' => 'Eosinophils %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'basophils_percent' => ['name' => 'Basophils %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'neutrophils_absolute' => ['name' => 'Neutrophils (Absolute)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    'lymphocytes_absolute' => ['name' => 'Lymphocytes (Absolute)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    'monocytes_absolute' => ['name' => 'Monocytes (Absolute)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    'eosinophils_absolute' => ['name' => 'Eosinophils (Absolute)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    'basophils_absolute' => ['name' => 'Basophils (Absolute)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    // WBC Differential Groups (BHA 3000 style)
                    'mid_percent' => ['name' => 'MID %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'mid_absolute' => ['name' => 'MID #', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    'gran_percent' => ['name' => 'GRAN %', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'gran_absolute' => ['name' => 'GRAN #', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => false],
                    // Red Blood Cells
                    'rbc' => ['name' => 'Red Blood Cells (RBC)', 'unit' => 'x10⁶/μL', 'type' => 'numeric', 'required' => true],
                    'hemoglobin' => ['name' => 'Hemoglobin (HGB)', 'unit' => 'g/dL', 'type' => 'numeric', 'required' => true],
                    'hematocrit' => ['name' => 'Hematocrit (HCT)', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'mcv' => ['name' => 'Mean Corpuscular Volume (MCV)', 'unit' => 'fL', 'type' => 'numeric', 'required' => true],
                    'mch' => ['name' => 'Mean Corpuscular Hemoglobin (MCH)', 'unit' => 'pg', 'type' => 'numeric', 'required' => true],
                    'mchc' => ['name' => 'Mean Corpuscular HGB Conc. (MCHC)', 'unit' => 'g/dL', 'type' => 'numeric', 'required' => true],
                    'rdw_cv' => ['name' => 'Red Cell Distribution Width (RDW-CV)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    // Platelets
                    'platelets' => ['name' => 'Platelets (PLT)', 'unit' => 'x10³/μL', 'type' => 'numeric', 'required' => true],
                    'mpv' => ['name' => 'Mean Platelet Volume (MPV)', 'unit' => 'fL', 'type' => 'numeric', 'required' => false],
                    'pdw' => ['name' => 'Platelet Distribution Width (PDW)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'pct' => ['name' => 'Plateletcrit (PCT)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'p_lcr' => ['name' => 'Platelet-Large Cell Ratio (P-LCR)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                ],
                'status' => 'active',
            ...
            [
                ...
                'turnaround_time' => 4,
                'unit' => 'Various',
                'normal_values' => 'WBC: 4.5-11.0, RBC: 4.5-6.2, HGB: 13-18, HCT: 40-54%, PLT: 150-450, MCV: 75-95, MCH: 26-34, MCHC: 31-38',
                'reference_ranges' => [
                    // White Blood Cells
                    'wbc' => ['min' => 4.5, 'max' => 11.0, 'unit' => 'x10³/μL', 'default' => null],
                    'lymphocytes_percent' => ['min' => 20, 'max' => 40, 'unit' => '%', 'default' => null],
                    'mid_percent' => ['min' => 2.0, 'max' => 10.0, 'unit' => '%', 'default' => null],
                    'gran_percent' => ['min' => 54, 'max' => 62, 'unit' => '%', 'default' => null],
                    'lymphocytes_absolute' => ['min' => 2.0, 'max' => 4.0, 'unit' => 'x10³/μL', 'default' => null],
                    'mid_absolute' => ['min' => 0.1, 'max' => 1.5, 'unit' => 'x10³/μL', 'default' => null],
                    'gran_absolute' => ['min' => 2.0, 'max' => 6.0, 'unit' => 'x10³/μL', 'default' => null],
                    // Red Blood Cells
                    'rbc' => ['min' => 4.5, 'max' => 6.2, 'unit' => 'x10⁶/μL', 'default' => null],
                    'hemoglobin' => ['min' => 13.0, 'max' => 18.0, 'unit' => 'g/dL', 'default' => null],
                    'hematocrit' => ['min' => 40, 'max' => 54, 'unit' => '%', 'default' => null],
                    'mcv' => ['min' => 75, 'max' => 95, 'unit' => 'fL', 'default' => null],
                    'mch' => ['min' => 26, 'max' => 34, 'unit' => 'pg', 'default' => null],
                    'mchc' => ['min' => 31, 'max' => 38, 'unit' => 'g/dL', 'default' => null],
                    'rdw_cv' => ['min' => 11, 'max' => 16, 'unit' => '%', 'default' => null],
                    // Platelets
                    'platelets' => ['min' => 150, 'max' => 450, 'unit' => 'x10³/μL', 'default' => null],
                    'mpv' => ['min' => 6.5, 'max' => 11.7, 'unit' => 'fL', 'default' => null],
                    'pdw' => ['min' => 8.3, 'max' => 56.6, 'unit' => '%', 'default' => null],
                    'pct' => ['min' => 0.12, 'max' => 0.24, 'unit' => '%', 'default' => null],
                    'p_lcr' => ['min' => 13, 'max' => 43, 'unit' => '%', 'default' => null],
                ],
                'parameters' => [
                    // White Blood Cells - BHA 3000 Style (matching actual lab reports)
                    'wbc' => ['name' => 'TOTAL LEUCOCYTE COUNT (TLC/WBC)', 'unit' => '10^9/L', 'type' => 'numeric', 'required' => true],
                    'neutrophils_absolute' => ['name' => 'Neu #', 'unit' => '10^9/L', 'type' => 'numeric', 'required' => true],
                    'lymphocytes_absolute' => ['name' => 'Lym #', 'unit' => '10^9/L', 'type' => 'numeric', 'required' => true],
                    'monocytes_absolute' => ['name' => 'Mxd #', 'unit' => '10^9/L', 'type' => 'numeric', 'required' => true],
                    'neutrophils_percent' => ['name' => 'Neu %', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'lymphocytes_percent' => ['name' => 'Lym %', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'monocytes_percent' => ['name' => 'Mxd %', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    // Red Blood Cells
                    'rbc' => ['name' => 'RBC', 'unit' => '10^12/L', 'type' => 'numeric', 'required' => true],
                    'hemoglobin' => ['name' => 'HGB/HEMOGLOBIN', 'unit' => 'g/L', 'type' => 'numeric', 'required' => true],
                    'hematocrit' => ['name' => 'HCT', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'mcv' => ['name' => 'MCV', 'unit' => 'FL', 'type' => 'numeric', 'required' => true],
                    'mch' => ['name' => 'MCH', 'unit' => 'PG', 'type' => 'numeric', 'required' => true],
                    'mchc' => ['name' => 'MCHC', 'unit' => 'g/L', 'type' => 'numeric', 'required' => true],
                    'rdw_cv' => ['name' => 'RDW-CV', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'rdw_sd' => ['name' => 'RDW-SD', 'unit' => 'FL', 'type' => 'numeric', 'required' => false],
                    // Platelets
                    'platelets' => ['name' => 'PLATELETS COUNT', 'unit' => '10^9/L', 'type' => 'numeric', 'required' => true],
                    'mpv' => ['name' => 'MPV', 'unit' => 'FL', 'type' => 'numeric', 'required' => false],
                    'pdw' => ['name' => 'PDW', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'pct' => ['name' => 'PCT', 'unit' => 'mL/L', 'type' => 'numeric', 'required' => false],
                    'p_lcr' => ['name' => 'P-LCR', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'p_lcc' => ['name' => 'P-LCC', 'unit' => '10^9/L', 'type' => 'numeric', 'required' => false],
                ],
                'status' => 'active',
                'requires_fasting' => false,
                'is_panel' => true,
            ...
            [
                ...
                'turnaround_time' => 4,
                'unit' => 'Various',
                'normal_values' => 'WBC: 4.5-11.0, RBC: 4.0-5.5, HGB: 12-16, HCT: 37-47%, PLT: 150-450, MCV: 75-95, MCH: 26-34, MCHC: 31-38',
                'reference_ranges' => [
                    // White Blood Cells
                    'wbc' => ['min' => 4.5, 'max' => 11.0, 'unit' => 'x10³/μL', 'default' => null],
                    'lymphocytes_percent' => ['min' => 20, 'max' => 40, 'unit' => '%', 'default' => null],
                    ...
                    'gran_absolute' => ['min' => 2.0, 'max' => 6.0, 'unit' => 'x10³/μL', 'default' => null],
                    // Red Blood Cells
                    'rbc' => ['min' => 4.0, 'max' => 5.5, 'unit' => 'x10⁶/μL', 'default' => null],
                    'hemoglobin' => ['min' => 12.0, 'max' => 16.0, 'unit' => 'g/dL', 'default' => null],
                    'hematocrit' => ['min' => 37, 'max' => 47, 'unit' => '%', 'default' => null],
                    'mcv' => ['min' => 75, 'max' => 95, 'unit' => 'fL', 'default' => null],
                    'mch' => ['min' => 26, 'max' => 34, 'unit' => 'pg', 'default' => null],
                    'mchc' => ['min' => 31, 'max' => 38, 'unit' => 'g/dL', 'default' => null],
                    'rdw_cv' => ['min' => 11, 'max' => 16, 'unit' => '%', 'default' => null],
            ...
            [
                ...
                'category' => 'Hematology',
                'description' => 'Complete Blood Count using BHA 3000 analyzer for children with full differential (1-8 years)',
                'procedure' => 'Automated hematology analysis using BHA 3000 analyzer',
                'sample_type' => 'Blood (EDTA)',
                ...
                'turnaround_time' => 4,
                'unit' => 'Various',
                'normal_values' => 'WBC: 5.0-15.0, RBC: 4.0-5.2, HGB: 11.5-14.8 (8 yrs), HCT: 33-48%, PLT: 150-450, MCV: 75-95, MCH: 24-30, MCHC: 31-35',
                'reference_ranges' => [
                    // White Blood Cells
                    'wbc' => ['min' => 5.0, 'max' => 15.0, 'unit' => 'x10³/μL', 'default' => null],
                    'lymphocytes_percent' => ['min' => 25, 'max' => 55, 'unit' => '%', 'default' => null],
                    'mid_percent' => ['min' => 2.0, 'max' => 10.0, 'unit' => '%', 'default' => null],
                    'gran_percent' => ['min' => 30, 'max' => 60, 'unit' => '%', 'default' => null],
                    'lymphocytes_absolute' => ['min' => 1.5, 'max' => 8.0, 'unit' => 'x10³/μL', 'default' => null],
                    'mid_absolute' => ['min' => 0.1, 'max' => 1.5, 'unit' => 'x10³/μL', 'default' => null],
                    'gran_absolute' => ['min' => 1.5, 'max' => 9.0, 'unit' => 'x10³/μL', 'default' => null],
                    // Red Blood Cells
                    'rbc' => ['min' => 4.0, 'max' => 5.2, 'unit' => 'x10⁶/μL', 'default' => null],
                    'hemoglobin' => ['min' => 11.0, 'max' => 16.0, 'unit' => 'g/dL', 'default' => null],
                    'hematocrit' => ['min' => 33, 'max' => 48, 'unit' => '%', 'default' => null],
                    'mcv' => ['min' => 75, 'max' => 95, 'unit' => 'fL', 'default' => null],
                    'mch' => ['min' => 24, 'max' => 30, 'unit' => 'pg', 'default' => null],
                    'mchc' => ['min' => 31, 'max' => 35, 'unit' => 'g/dL', 'default' => null],
                    'rdw_cv' => ['min' => 11.5, 'max' => 15.5, 'unit' => '%', 'default' => null],
                    // Platelets
                    'platelets' => ['min' => 150, 'max' => 450, 'unit' => 'x10³/μL', 'default' => null],
                    'mpv' => ['min' => 7.0, 'max' => 11.0, 'unit' => 'fL', 'default' => null],
                    'pdw' => ['min' => 8.3, 'max' => 56.6, 'unit' => '%', 'default' => null],
                    'pct' => ['min' => 0.12, 'max' => 0.24, 'unit' => '%', 'default' => null],
                    'p_lcr' => ['min' => 13, 'max' => 43, 'unit' => '%', 'default' => null],
                ],
    ...
    private function getBiochemistryTests(): array
    {
        return [
            ...
            [
                ...
                'name' => 'Bile Salt',
                'category' => 'Biochemistry',
                'description' => 'Detection of bile salts in serum for liver function assessment',
                ...
                'reference_ranges' => [
                    'result' => ['values' => ['Negative', 'Positive'], 'default' => 'Negative']
                ],
                'parameters' => [
                    'result' => ['name' => 'Bile Salt', 'unit' => '', 'type' => 'select', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ],
            [
                'test_code' => 'BILE-PIGMENT',
                'name' => 'Bile Pigment',
                'category' => 'Biochemistry',
                'description' => 'Detection of bile pigments in serum for liver and hemolytic disorders',
                'procedure' => 'Colorimetric method',
                'sample_type' => 'Blood (Serum)',
                'cost' => 200.00,
                'turnaround_time' => 4,
                ...
                'parameters' => [
                    'result' => ['name' => 'Bile Pigment', 'unit' => '', 'type' => 'select', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ],
            [
                ...
                'category' => 'Biochemistry',
                'description' => 'Glucose-6-phosphate dehydrogenase enzyme activity for hemolytic anemia screening',
                'procedure' => 'Quantitative enzyme assay',
                'sample_type' => 'Blood (EDTA)',
                'cost' => 500.00,
                'turnaround_time' => 24,
                'unit' => 'U/g Hb',
                'normal_values' => 'Normal: 6.0-12.0 U/g Hb, Deficient: <4.0 U/g Hb',
                'reference_ranges' => [
                    'g6pd_activity' => ['min' => 6.0, 'max' => 12.0, 'unit' => 'U/g Hb', 'default' => null],
                    'status' => ['values' => ['Normal', 'Deficient', 'Intermediate'], 'default' => 'Normal']
                ],
                'parameters' => [
                    'g6pd_activity' => ['name' => 'G6PD Activity', 'unit' => 'U/g Hb', 'type' => 'numeric', 'required' => true],
                    'status' => ['name' => 'Interpretation', 'unit' => '', 'type' => 'select', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ],
            [
                ...
                'reference_ranges' => [
                    'serum_iron' => ['min' => 60, 'max' => 170, 'unit' => 'μg/dL', 'default' => null],
                    'tibc' => ['min' => 250, 'max' => 450, 'unit' => 'μg/dL', 'default' => null],
                    'transferrin_saturation' => ['min' => 20, 'max' => 50, 'unit' => '%', 'default' => null],
                    'serum_transferrin' => ['min' => 200, 'max' => 360, 'unit' => 'mg/dL', 'default' => null],
                    'ferritin' => ['min' => 20, 'max' => 200, 'unit' => 'ng/mL', 'default' => null]
                ],
                'parameters' => [
                    'serum_iron' => ['name' => 'Serum Iron', 'unit' => 'μg/dL', 'type' => 'numeric', 'required' => true],
                    'tibc' => ['name' => 'TIBC (Total Iron Binding Capacity)', 'unit' => 'μg/dL', 'type' => 'numeric', 'required' => true],
                    'transferrin_saturation' => ['name' => 'Transferrin Saturation', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'serum_transferrin' => ['name' => 'Serum Transferrin', 'unit' => 'mg/dL', 'type' => 'numeric', 'required' => false],
                    'ferritin' => ['name' => 'Ferritin', 'unit' => 'ng/mL', 'type' => 'numeric', 'required' => true] 
                ],
                'status' => 'active',
            ],
            [
            ...
            [
                ...
                'parameters' => [
                    't3' => ['name' => 'T3 (Triiodothyronine)', 'unit' => 'ng/mL', 'type' => 'numeric', 'required' => true],
                    't4' => ['name' => 'T4 (Thyroxine)', 'unit' => 'μg/dL', 'type' => 'numeric', 'required' => true],
                    'tsh' => ['name' => 'TSH', 'unit' => 'μIU/mL', 'type' => 'numeric', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
                'is_panel' => true,
            ...
            [
                ...
                'name' => 'Free T4 (FT4)',
                'category' => 'Biochemistry',
                'description' => 'Free thyroxine level for thyroid function assessment',
                'procedure' => 'Chemiluminescent immunoassay',
                'sample_type' => 'Blood (Serum)',
                'cost' => 450.00,
                'turnaround_time' => 8,
                ...
                'reference_ranges' => [
                    'ft4' => ['min' => 0.8, 'max' => 1.8, 'unit' => 'ng/dL', 'default' => null]
                ],
                'parameters' => [
                    'ft4' => ['name' => 'Free T4', 'unit' => 'ng/dL', 'type' => 'numeric', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ],
            [
                ...
                'name' => 'Free T3 (FT3)',
                'category' => 'Biochemistry',
                'description' => 'Free triiodothyronine level for thyroid function assessment',
                'procedure' => 'Chemiluminescent immunoassay',
                'sample_type' => 'Blood (Serum)',
                'cost' => 450.00,
                'turnaround_time' => 8,
                ...
                'reference_ranges' => [
                    'ft3' => ['min' => 2.3, 'max' => 4.2, 'unit' => 'pg/mL', 'default' => null]
                ],
                'parameters' => [
                    'ft3' => ['name' => 'Free T3', 'unit' => 'pg/mL', 'type' => 'numeric', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ],
            ...
            [
                ...
                'parameters' => [
                    'testosterone' => ['name' => 'Testosterone', 'unit' => 'ng/mL', 'type' => 'numeric', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ...
            [
                ...
                'category' => 'Biochemistry',
                'description' => 'Female sex hormone level for fertility and menstrual cycle assessment',
                'procedure' => 'Chemiluminescent immunoassay',
                'sample_type' => 'Blood (Serum)',
                'cost' => 600.00,
                'turnaround_time' => 8,
                'unit' => 'pg/mL',
                'normal_values' => 'Female - Follicular: 30-120, Ovulatory: 130-370, Luteal: 70-250, Postmenopausal: 0-40 pg/mL; Male: 10-40 pg/mL',
                'reference_ranges' => [
                    'follicular' => ['min' => 30, 'max' => 120, 'unit' => 'pg/mL', 'default' => null],
                    'ovulatory' => ['min' => 130, 'max' => 370, 'unit' => 'pg/mL', 'default' => null],
                    'luteal' => ['min' => 70, 'max' => 250, 'unit' => 'pg/mL', 'default' => null],
                    'postmenopausal' => ['min' => 0, 'max' => 40, 'unit' => 'pg/mL', 'default' => null],
                    'male' => ['min' => 10, 'max' => 40, 'unit' => 'pg/mL', 'default' => null]
                ],
                'parameters' => [
                    'estradiol' => ['name' => 'Estradiol (E2)', 'unit' => 'pg/mL', 'type' => 'numeric', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
                'gender_specific' => 'female',
    ...
    private function getSemenTests(): array
    {
        return [
            [
                ...
                'parameters' => [
                    // Macroscopic
                    'volume' => ['name' => 'Semen Volume', 'unit' => 'mL', 'type' => 'numeric', 'required' => true],
                    'color' => ['name' => 'Color', 'unit' => '', 'type' => 'select', 'required' => true],
                    'appearance' => ['name' => 'Appearance', 'unit' => '', 'type' => 'select', 'required' => true],
                    'viscosity' => ['name' => 'Viscosity', 'unit' => '', 'type' => 'select', 'required' => false],
                    'liquefaction_time' => ['name' => 'Liquefaction Time', 'unit' => 'Minutes', 'type' => 'numeric', 'required' => false],
                    'ph' => ['name' => 'pH', 'unit' => '', 'type' => 'numeric', 'required' => true],
                    'method' => ['name' => 'Method', 'unit' => '', 'type' => 'select', 'required' => true],
                    // Sperm Count
                    'count' => ['name' => 'Sperm Concentration', 'unit' => 'million/mL', 'type' => 'numeric', 'required' => true],
                    'total_count' => ['name' => 'Total Sperm Count', 'unit' => 'million', 'type' => 'numeric', 'required' => true],
                    // Motility
                    'active' => ['name' => 'Active', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'sluggish' => ['name' => 'Sluggish', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'non_motile_dead' => ['name' => 'Non-Motile Or Dead', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'motility' => ['name' => 'Total Motility (PR+NP)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'progressive_motility' => ['name' => 'Progressive Motility (PR)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'non_progressive' => ['name' => 'Non-Progressive Motility (NP)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'immotile' => ['name' => 'Immotile Sperm', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    // Morphology
                    'normal_morphology' => ['name' => 'Normal', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'abnormal_morphology' => ['name' => 'Abnormal', 'unit' => '%', 'type' => 'numeric', 'required' => true],
                    'morphology' => ['name' => 'Normal Morphology (WHO)', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'head_defects' => ['name' => 'Head Defects', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'neck_defects' => ['name' => 'Neck/Midpiece Defects', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'tail_defects' => ['name' => 'Tail Defects', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    // Other
                    'vitality' => ['name' => 'Sperm Vitality', 'unit' => '%', 'type' => 'numeric', 'required' => false],
                    'agglutination' => ['name' => 'Agglutination', 'unit' => '', 'type' => 'select', 'required' => false],
                    'pus_cells' => ['name' => 'Pus Cells (WBC)', 'unit' => '/HPF', 'type' => 'numeric', 'required' => false],
                    'rbc' => ['name' => 'Rbc Cells', 'unit' => '/HPF', 'type' => 'numeric', 'required' => false],
                    'bacteria' => ['name' => 'Bacteria', 'unit' => '', 'type' => 'select', 'required' => false],
                    'epithelial_cells' => ['name' => 'Epithelial Cells', 'unit' => '/HPF', 'type' => 'numeric', 'required' => false]
                ],
                'status' => 'active',
                'requires_fasting' => false,
                'is_panel' => true,
    ...
    private function getSpecialTests(): array
    {
        return [
            ...
            [
                ...
                'parameters' => [
                    'vit_b12' => ['name' => 'Vitamin B12', 'unit' => 'pg/mL', 'type' => 'numeric', 'required' => true]
                ],
                'status' => 'active',
                'requires_fasting' => false,
            ],
            // Vaccines Section
            [
                'test_code' => 'VAC-HBV-ADULT',
                'name' => 'HBV Vaccine (Adult Dose)',
                'category' => 'Special',
                'description' => 'Hepatitis B vaccine for adults (3-dose series)',
                'procedure' => 'Intramuscular injection',
                'sample_type' => 'N/A',
                'cost' => 800.00,
                'turnaround_time' => 0,
                'unit' => 'Dose',
                'normal_values' => 'Schedule: 0, 1, 6 months',
                'reference_ranges' => [
                    'dose_number' => ['values' => ['Dose 1', 'Dose 2', 'Dose 3', 'Booster'], 'default' => 'Dose 1'],
                    'response' => ['values' => ['Pending', 'Completed', 'Immune'], 'default' => 'Pending']
                ],
                'parameters' => [
                    'dose_number' => ['name' => 'Dose Number', 'unit' => '', 'type' => 'select', 'required' => true],
                    'response' => ['name' => 'Immune Response', 'unit' => '', 'type' => 'select', 'required' => false],
                    'anti_hbs_titer' => ['name' => 'Anti-HBs Titer', 'unit' => 'mIU/mL', 'type' => 'numeric', 'required' => false]
                ],
                'status' => 'active',
                'is_vaccine' => true,
            ],
            [
                'test_code' => 'VAC-HBV-CHILD',
                'name' => 'HBV Vaccine (Children Dose)',
                'category' => 'Special',
                'description' => 'Hepatitis B vaccine for children (3-dose series)',
                'procedure' => 'Intramuscular injection',
                'sample_type' => 'N/A',
                'cost' => 600.00,
                'turnaround_time' => 0,
            ...
            [
                'test_code' => 'VAC-TYPHOID',
                'name' => 'Typhoid Vaccine',
                'category' => 'Special',
                'description' => 'Typhoid fever vaccine (Vi polysaccharide or live oral)',
                'procedure' => 'Intramuscular injection or oral',
                'sample_type' => 'N/A',
                'cost' => 500.00,
                'turnaround_time' => 0,
                'unit' => 'Dose',
                'normal_values' => 'Booster every 2-3 years',
                'reference_ranges' => [
                    'vaccine_type' => ['values' => ['Vi Polysaccharide', 'Live Oral'], 'default' => 'Vi Polysaccharide'],
                    'dose_number' => ['values' => ['Dose 1', 'Dose 2', 'Dose 3', 'Dose 4', 'Booster'], 'default' => 'Dose 1']
                ],
                'parameters' => [
                    'vaccine_type' => ['name' => 'Vaccine Type', 'unit' => '', 'type' => 'select', 'required' => true],
                    'dose_number' => ['name' => 'Dose Number', 'unit' => '', 'type' => 'select', 'required' => true],
                    'date_given' => ['name' => 'Date Given', 'unit' => '', 'type' => 'date', 'required' => true]
                ],
                'status' => 'active',
                'is_vaccine' => true,
            ],
            [
                'test_code' => 'VAC-INFLUENZA',
                'name' => 'Influenza Vaccine',
                'category' => 'Special',
                'description' => 'Seasonal influenza vaccine (annual)',
                'procedure' => 'Intramuscular or intradermal injection',
                'sample_type' => 'N/A',
                'cost' => 400.00,
                'turnaround_time' => 0,
                'unit' => 'Dose',
                'normal_values' => 'Annual vaccination recommended',
                'reference_ranges' => [
                    'vaccine_type' => ['values' => ['Quadrivalent', 'Trivalent'], 'default' => 'Quadrivalent'],
                    'season' => ['values' => ['2025-2026', '2026-2027'], 'default' => '2025-2026']
                ],
                'parameters' => [
                    'vaccine_type' => ['name' => 'Vaccine Type', 'unit' => '', 'type' => 'select', 'required' => true],
                    'season' => ['name' => 'Season', 'unit' => '', 'type' => 'select', 'required' => true],
                    'date_given' => ['name' => 'Date Given', 'unit' => '', 'type' => 'date', 'required' => true]
                ],
                'status' => 'active',
                'is_vaccine' => true,
            ...
            [
                'test_code' => 'VAC-PNEUMO',
                'name' => 'Pneumococcal Vaccine',
                'category' => 'Special',
                'description' => 'Pneumococcal conjugate or polysaccharide vaccine',
                'procedure' => 'Intramuscular injection',
                'sample_type' => 'N/A',
                'cost' => 1200.00,
                'turnaround_time' => 0,
                'unit' => 'Dose',
                'normal_values' => 'PCV13 or PPSV23 as indicated',
                'reference_ranges' => [
                    'vaccine_type' => ['values' => ['PCV13', 'PPSV23'], 'default' => 'PCV13'],
                    'dose_number' => ['values' => ['Dose 1', 'Dose 2', 'Dose 3', 'Booster'], 'default' => 'Dose 1']
                ],
                'parameters' => [
                    'vaccine_type' => ['name' => 'Vaccine Type', 'unit' => '', 'type' => 'select', 'required' => true],
            ...
            [
                ...
                'category' => 'Special',
                'description' => 'Hepatitis A vaccine (2-dose series)',
                'procedure' => 'Intramuscular injection',
                'sample_type' => 'N/A',
                'cost' => 700.00,
                'turnaround_time' => 0,
                'unit' => 'Dose',
                'normal_values' => 'Schedule: 0, 6-12 months',
                'reference_ranges' => [
                    'dose_number' => ['values' => ['Dose 1', 'Dose 2', 'Booster'], 'default' => 'Dose 1'],
                    'response' => ['values' => ['Pending', 'Completed', 'Immune'], 'default' => 'Pending']
                ],
                'parameters' => [
                    'dose_number' => ['name' => 'Dose Number', 'unit' => '', 'type' => 'select', 'required' => true],
