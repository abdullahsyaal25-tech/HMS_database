...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::middleware(['check.permission:view-users', 'permission.monitoring'])->prefix('admin')->group(function () {
        Route::prefix('users')->group(function () {
            ...
            Route::get('/{user}/permissions', [App\Http\Controllers\Admin\PermissionsController::class, 'userPermissions'])->name('admin.users.permissions')->middleware('check.permission:manage-user-permissions');
