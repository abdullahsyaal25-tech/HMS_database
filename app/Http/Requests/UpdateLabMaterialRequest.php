...
class UpdateLabMaterialRequest extends FormRequest
{
    ...
    {
        return auth()->check() && auth()->user()->hasPermission('edit-lab-materials');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'lab_test_id' => 'sometimes|nullable|exists:lab_tests,id',
            'description' => 'sometimes|nullable|string|max:1000',
            'status' => 'sometimes|required|string|in:active,low_stock,out_of_stock',
